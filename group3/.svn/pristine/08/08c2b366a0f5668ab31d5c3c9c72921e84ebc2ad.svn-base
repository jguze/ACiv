...
public class CivFrame extends JFrame implements ActionListener
{
    ...
    private void setup() {
        ...
        miniMapView = new MiniMapView(202,122);
        ...
        viewTree = new JMenuItem("Research Tree", 'r');        
        ...
        CP.setPreferredSize(new Dimension(850, 600));
        
        frameSize = new Dimension(850, 600);
        WindowUtils.centerOnScreen(this, frameSize);
        ...
        turnCounter = new JLabel("2000");
        turnCounter.setHorizontalTextPosition(JLabel.RIGHT);
        turnCounter.setFont(new Font("Courier", Font.PLAIN, 16));
        turnCounter.setForeground(Color.WHITE);
        turnCounter.setFocusable(false);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == turnDone) {
            ...
            yes = JOptionPane.showConfirmDialog(null, "Are you sure you want to quit?", "Input", JOptionPane.YES_NO_OPTION);
    ...
    private GridBagLayout createLayout()
    {
        ...
        GBL.columnWidths = new int[] {210, 640};
    ...
    {
        GridBagLayout GBL = new GridBagLayout();
        GBL.columnWidths = new int[] {30, 113, 40};
    ...
    private void createPlayerDataPanel() {
        ...
        playerInfoPanel.setPreferredSize(new Dimension(202,152));
